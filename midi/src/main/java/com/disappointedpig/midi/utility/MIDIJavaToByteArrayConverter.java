...
public class MIDIJavaToByteArrayConverter {
    /**
    ...
    public MIDIJavaToByteArrayConverter() {
...
//            stream.write('I');
            ...
            throw new UnsupportedOperationException("Do not know the MIDI type for the java class: "
                    + typeClass);
        }
    }
